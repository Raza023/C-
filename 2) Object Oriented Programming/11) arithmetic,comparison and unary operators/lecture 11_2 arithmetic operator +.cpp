...
public: 
    ...
    Rectangle operator+(const Rectangle &right); //optional to pass by value or by refernce        return result
    Rectangle operator-(const Rectangle &right); //optional to pass by value or by refernce        return result
    Rectangle operator*(const Rectangle &right); //optional to pass by value or by refernce        return result
    Rectangle operator/(const Rectangle &right); //optional to pass by value or by refernce        return result
//    Rectangle operator%(const Rectangle &right); //optional to pass by value or by refernce	       return result            should use int%int for it.
};
...
/*
Rectangle Rectangle::operator%(const Rectangle &right) //optional to pass by value or by refernce    int%int
{
	cout<<"operator% is called....."<<endl;
	Rectangle result;
	result.length=length%right.length;
