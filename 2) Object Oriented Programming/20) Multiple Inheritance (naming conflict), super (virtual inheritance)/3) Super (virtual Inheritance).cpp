...
class Student: virtual private Person // public Person //now inherited         //derived class
{
	string rollNo;
	double cgpa;
public:
	using Person::printPerson;   //access redefinetion    no () here because it's pointer
	Student():Person()
	{
		rollNo="BITF19A023";
		cgpa=3.82;
...
public:
	TA()
	{
		cout<<"TA appointed..."<<endl;
	}
	~TA()
	{
		cout<<"TA Terminated..."<<endl;
	}
};
